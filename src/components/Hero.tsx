...
import heroBuildingBg from "../assets/images/hero_building_cloudy_dawn_1779578340877.png";
...
export default function Hero() {
  ...
  return (
    <section className="relative flex items-center min-h-screen pt-24 overflow-hidden bg-background">
      {/* Background Exterior Image, Video & Cover Masks */}
      <div className="absolute inset-0 z-0 overflow-hidden bg-[#081018]">
        ...
        {/* Hero Video with 95% opacity */}
        <video
          ref={videoRef}
          src="/videos/Herosectionvideoadapt.mp4"
          className="absolute inset-0 w-full h-full object-cover opacity-95 select-none scale-102 z-10 pointer-events-none"
          autoPlay
          muted
          playsInline
        />

        {/* Cinematic gradients overlay to guarantee text legibility and page blending */}
        ...
        {/* Unified Mobile Overlay for touch interface */}
        ...
        {/* Ambient radial lighting for visual polish */}
